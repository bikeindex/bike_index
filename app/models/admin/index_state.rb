...
module Admin
  ...
  IndexState = Data.define(
    ...
    def initialize(params: {}, sort_state: SortState.new, render_chart: false, render_deleted: nil,
      pagy: nil, per_page: nil, time_range: nil, period: nil, start_time: nil, end_time: nil,
      current_organization: nil, user_subject: nil, bike: nil, marketplace_listing: nil,
      primary_activity: nil, time_range_column: nil)
      super
    end
