...
class BParam < ApplicationRecord
  ...
  class << self
    ...
    def v2_params(hash)
      ...
      if h["bike"].key?("owner_email_is_phone_number")
        h["bike"]["is_phone"] = BinxUtils::InputNormalizer.boolean(h["bike"].delete("owner_email_is_phone_number"))
      end
    ...
    def status_hash_from_params(action_controller_params = nil)
      ...
      return {status: "status_stolen"} if BinxUtils::InputNormalizer.boolean(url_params[:stolen])
    ...
    def propulsion_type(passed_params)
      ...
      throttle = BinxUtils::InputNormalizer.boolean(passed_params["propulsion_type_throttle"])
      pedal_assist = BinxUtils::InputNormalizer.boolean(passed_params["propulsion_type_pedal_assist"])

      if pedal_assist
        throttle ? "pedal-assist-and-throttle" : "pedal-assist"
      elsif throttle
        "throttle"
      elsif BinxUtils::InputNormalizer.boolean(passed_params["propulsion_type_motorized"])
        "motorized"
      else
  ...
  def status
    ...
    return "status_stolen" if stolen_attrs.present? || BinxUtils::InputNormalizer.boolean(bike["stolen"])
  ...
  def skip_email?
    ...
    send_email.present? && !BinxUtils::InputNormalizer.boolean(send_email)
  end
  ...
  def clean_params(updated_params = {})
    ...
    params.delete("propulsion_type_motorized") unless BinxUtils::InputNormalizer.boolean(params["propulsion_type_motorized"])
  ...
  def parking_notification_params
    ...
    attrs.merge(organization_id: creation_organization_id,
      ...
      use_entered_address: BinxUtils::InputNormalizer.boolean(attrs[:use_entered_address]))
  end
  ...
  def clean_key_value(key, value)
    return unless BinxUtils::InputNormalizer.present_or_false?(value)

    clean_value = value.is_a?(String) ? BinxUtils::InputNormalizer.sanitize(value) : value
    [key, clean_value]
  end
