...
class Ownership < ApplicationRecord
  ...
  def set_calculated_attributes
    ...
    if id.blank? # Some things to set only on create
      ...
      # Would this be better in BikeService::Creator? Maybe, but specs depend on this always being set
  ...
  def send_notification_and_update_other_ownerships
    ...
    # Note: this has to be performed later; we create ownerships and then delete them, in BikeService::Creator
