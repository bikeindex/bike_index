...
class EmailDomain < ApplicationRecord
  ...
  def spam_score_sendgrid_validations
    ...
    data["sendgrid_validations"].values.map { |result| result["score"].to_f }.max.round(1)
  end
