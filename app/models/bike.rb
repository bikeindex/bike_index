class Bike < ActiveRecord::Base  
  ...
  attr_accessor :date_stolen_input, :phone, :remote_image_url, :image, :bike_token_id, :b_param_id, :payment_required, :embeded, :embeded_extended, :paint_name, :bike_image_cache, :send_email
