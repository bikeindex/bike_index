...
// Shows the selected filename (or a count for multiple files) and frames the controls as a drop
// target while a file is dragged over the page. What becomes of a pick is up to the controller
// around it, which hears `ui--forms--files--picker:picked`.
export default class extends Controller {
  ...
  display () {
    ...
    this.dispatch('picked', { detail: { files: [...files], input: this.inputTarget } })
  }
}
