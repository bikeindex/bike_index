...
export default class extends Controller {
  ...
  toggle (event) {
    ...
    if (this.element.open) {
      collapse('hide', this.contentTarget, this.durationValue)
      this.closeTimer = setTimeout(() => { this.element.open = false }, this.durationValue)
    } else {
      this.element.open = true
      collapse('show', this.contentTarget, this.durationValue)
    }
  }
}
