...
module Pages
  module Org
    module RegisterStep1
      # The register flow's opening page on an organization's own page, with the switches
      # that decide its shape below it - the way back to the embed form it replaces, and
      # the two that change the flow itself
      class Component < ApplicationComponent
        ...
        def opening_page
          ...
          component.new(b_param: @b_param, steps: @steps, current_user: @current_user, skip_heading: true)
        end
