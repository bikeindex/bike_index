      ...
      module BikesTable
        ...
        class Component < ApplicationComponent
          ...
          TABLE_CLASSES = [
            ...
            # The sorted column keeps twlink-underlined's bold, but not its thicker underline - ! to
            # outrank its active rule
            "tw:[&_th]:uppercase tw:[&_th_a[data-active]]:decoration-auto!",
