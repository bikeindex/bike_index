    ...
    module SearchResults
      module BikesTable
        ...
        class Component < ApplicationComponent
          ...
          # Mirrored on the right edge while there's more to scroll to - except in a full-bleed row,
          ...
          WRAPPER_CLASSES = "tw:group/bikes-table tw:relative tw:data-overflowing:after:absolute " \
            ...
            "tw:data-overflowing:after:w-px tw:data-overflowing:after:shadow-[-2px_0_6px_rgba(26,26,31,0.04)] " \
