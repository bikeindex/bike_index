      ...
      module MultiResults
        class Component < ApplicationComponent
          def initialize(organization:, query:, chip_id:, pagy:, search_kind: "serials",
            bikes: nil, close_serials: nil, sort_state: ComponentStructs::SortState.new)
          ...
          def query_atom
            return Atoms::Sticker::Component.new(pretty_code: @query) if sticker_search?

            Atoms::Serial::Component.new(serial: @query)
          end
