  ...
  module Register
    module Embed
      ...
      class Component < ApplicationComponent
        def initialize(b_param:, flow:, header_tags_options:, current_user: nil, button_color: nil, button_hover_color: nil)
          @b_param = b_param
        ...
        def before_render
          @body = render Pages::Register::StartPage::Component.new(b_param: @b_param, flow: @flow,
