    ...
    module ForSaleItem
      class Component < ApplicationComponent
        def initialize(result_view: nil, current_user: nil, vehicle: nil, vehicle_id: nil, marketplace_listing: nil)
          @component_class = Pages::SearchResults::Container::Component.component_class_for_result_view(result_view || :bike_box)
        ...
        def container_class
          Pages::SearchResults::Container::Component.container_class(@component_class)
        end
      end
    end
  end
