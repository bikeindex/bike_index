    ...
    module Container
      class Component < ApplicationComponent
        RESULT_VIEW_COMPONENT = {
          bike_box: Pages::SearchResults::BikeBox::Component,
          thumbnail: Pages::SearchResults::VehicleThumbnail::Component
        }.freeze
        ...
        class << self
          ...
          def container_class(component_class)
            if component_class == Pages::SearchResults::VehicleThumbnail::Component
