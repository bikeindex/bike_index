  ...
  module Search
    module Form
      class ComponentPreview < ApplicationComponentPreview
        ...
        def default
          render(Pages::Search::Form::Component.new(**default_options(preview_name: "default")))
        end
        ...
        def chicago_tall_bike
          ...
          render(Pages::Search::Form::Component.new(**default_options(interpreted_params, preview_name: "chicago_tall_bike")))
        end
        ...
        def for_sale
          ...
          render(Pages::Search::Form::Component.new(**sale_options))
        end
        ...
        def target_search_path(preview_name)
          "/rails/view_components/pages/search/form/component/#{preview_name}"
        end
