    ...
    module FileUploadMultiple
      ...
      class Component < ApplicationComponent
        def initialize(url:, file_param:, params: {}, accept: nil, camera: nil, list_html_options: {})
          ...
          @accept = accept
          @camera = camera
          @data = {"ui--forms--file-upload-params-value": params, "ui--forms--file-upload-file-param-value": file_param}
          ...
          @input_options = {id: "file_upload_multiple_#{SecureRandom.hex(4)}", multiple: true}
        end
      end
    end
  end
