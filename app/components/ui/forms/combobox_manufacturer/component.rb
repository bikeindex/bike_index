...
module UI
  module Forms
    module ComboboxManufacturer
      ...
      # frames. html_options except `placeholder:` (form:, value:, required:, etc.) are
      # forwarded to UI::Forms::Combobox::Component, which renders no label -- wrap it
      # in a UI::Forms::Group block to get one.
      #
      ...
      class Component < ApplicationComponent
        ...
        def initialize(name: :manufacturer_id, frame_maker: false, no_manufacturer_other: false, no_js: false, html_options: {})
          @name = name
        ...
        def combobox_arguments
          {
            ...
            html_options: {**@html_options, placeholder: translation(".placeholder", name: PLACEHOLDER_NAMES.sample)},
            **no_js_options
          }.deep_merge(manufacturer_other_options)
        end
        ...
        def manufacturer_display
          ...
          manufacturer.other? ? @html_options[:form].object.manufacturer_other : manufacturer.name
        end
        ...
        def manufacturer
          ...
          @manufacturer = @html_options[:form]&.object.try(:manufacturer)
        end
        ...
        def manufacturer_other_options
          ...
          {name: form.field_name(@name),
           html_options: {form: nil, id: form.field_id(@name), value: form.object.manufacturer_other}}
        end
      end
    end
  end
