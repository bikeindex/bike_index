    ...
    module Form
      module Wrapper
        ...
        class Component < ApplicationComponent
          ...
          def layout_form
            if landing_page?
              Admin::CustomLayouts::Form::LandingPage::Component.new(organization: @organization,
                landing_page: @landing_page, suggested_button_hover: @suggested_button_hover)
            else
              Admin::CustomLayouts::Form::MailSnippet::Component.new(organization: @organization,
