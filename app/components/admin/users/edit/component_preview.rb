  ...
  module Users
    module Edit
      class ComponentPreview < ApplicationComponentPreview
        ...
        def default
          render(Admin::Users::Edit::Component.new(user: lookbook_user))
        end
        ...
        def banned
          ...
          render(Admin::Users::Edit::Component.new(user:))
        end

        def with_dev_info
          render(Admin::Users::Edit::Component.new(user: lookbook_user, display_dev_info: true))
        end
      end
    end
  end
