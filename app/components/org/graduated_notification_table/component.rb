...
module Org
  module GraduatedNotificationTable
    class Component < ApplicationComponent
      def initialize(graduated_notifications:, current_organization:, sort_state: SortState.new, display_dev_info: false, render_sortable: false, render_remaining_at: false, skip_status: false, skip_email: false, skip_email_search: nil, separate_secondary_notifications: false)
