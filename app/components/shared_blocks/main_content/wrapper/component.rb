    ...
    module Wrapper
      ...
      class Component < ApplicationComponent
        ...
        def content_component
          SharedBlocks::MainContent::Content::Component.new(
            blog: @blog,
            related_blogs: @related_blogs,
            source: @source,
            current_user: @current_user,
        ...
        def edit_bike_component
          SharedBlocks::MainContent::EditBike::Component.new(
            bike: @bike,
            bike_og: @bike_og,
            og_email: @og_email,
            edit_template: @edit_template,
        ...
        def oauth_applications_component
          SharedBlocks::MainContent::OauthApplications::Component.new(
            oauth_application: @oauth_application,
            current_user: @current_user,
            action_name: @action_name
          )
        ...
        def organized_component
          SharedBlocks::MainContent::Organized::Component.new(
            current_organization: @current_organization,
            current_user: @current_user,
            passive_organization: @passive_organization,
            show_general_alert: @show_general_alert,
