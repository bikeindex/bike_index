...
module SharedBlocks
  module SearchResults
    module BikeListItem
      ...
      # row (1d): BikeCard's contents, edged in the status's color. Deliberately a copy of
      # BikeCard rather than a subclass of it - a component inherits from
      ...
      class Component < ApplicationComponent
        ...
        # Lazily, so a cached row doesn't query it
        def organized?
