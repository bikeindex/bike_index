  ...
  module Navbar
    module Wrapper
      class ComponentPreview < ApplicationComponentPreview
        ...
        def default
          render(SharedBlocks::Navbar::Wrapper::Component.new)
        end

        # @display legacy_stylesheet true
        def signed_in
          render(SharedBlocks::Navbar::Wrapper::Component.new(current_user: lookbook_user,
            current_user_or_unconfirmed_user: lookbook_user))
        end

        # @display legacy_stylesheet true
        def logo_only
          render(SharedBlocks::Navbar::Wrapper::Component.new(logo_only: true))
        end
        # @endgroup
