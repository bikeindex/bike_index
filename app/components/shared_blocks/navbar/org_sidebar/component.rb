  ...
  module Navbar
    module OrgSidebar
      ...
      class Component < ApplicationComponent
        ...
        # is-active: ui--collapse flags an open group's toggle data-active, which it also reads
        ...
        def account_menu
          SharedBlocks::Navbar::AccountMenu::Component.new(current_user: @current_user,
