  ...
  class Component < ApplicationComponent
    ...
    def bike_tile_images
      (0..16).map { it.to_s.rjust(2, "0") }
        .map { image_url("kelsey_styles/bike_tiles/bike-entry_00#{it}.png") }
    end
      ...
      [
        {
          ...
          background: image_url("kelsey_styles/step1.gif"),
          rotation: 0
        },
        {
          stepNumber: "STEP 2",
          ...
          background: image_url("kelsey_styles/step2.gif"),
          rotation: 90
        },
        {
          stepNumber: "STEP 3",
          ...
          background: image_url("kelsey_styles/step3.gif"),
          rotation: 180
        },
        {
          stepNumber: "STEP 4",
          ...
          background: image_url("kelsey_styles/step4.gif"),
          rotation: 270
        }
      ]
    end
