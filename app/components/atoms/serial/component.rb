...
module Atoms
  module Serial
    ...
    class Component < ApplicationComponent
      ...
      def initialize(bike: nil, serial: nil, user: nil, organization: nil, explanation: :inline, html_class: nil)
        @bike = bike
        @serial = serial
        @user = user
      ...
      def serial
        @serial ||= @bike&.serial_display(@user, organization: @organization)
      end
