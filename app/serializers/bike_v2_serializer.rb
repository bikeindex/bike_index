class BikeV2Serializer < ActiveModel::Serializer
  ...
  def date_stolen
    object.current_stolenRecord && object.current_stolenRecord.date_stolen.to_i
  end
  ...
  def is_stock_img
    object.publicImages.present? ? false : object.stock_photo_url.present?
  end

  def stolen_location
    object.current_stolenRecord && object.current_stolenRecord.address_short
