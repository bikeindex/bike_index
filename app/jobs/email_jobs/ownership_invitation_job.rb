...
module EmailJobs
  class OwnershipInvitationJob < ApplicationJob
    ...
    def perform(ownership_id)
      ...
      if SpamEstimator::Bike.estimate(ownership.bike) > SpamEstimator::Bike::MARK_SPAM_PERCENT
      ...
      # Not skip_email, which latches: calculated_send_email reads it back and goes on
      # holding the email after the rules are agreed to
