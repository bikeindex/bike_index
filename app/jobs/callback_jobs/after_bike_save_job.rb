  ...
  class AfterBikeSaveJob < ApplicationJob
    ...
    def perform(bike_id, skip_user_update = false, resave_bike = false)
      ...
      unless skip_user_update
        ...
        CallbackJobs::AfterUserChangeJob.new.perform(bike.owner.id, bike.owner.reload, true) if bike.owner.present?
      end
    ...
    def update_matching_partial_registrations(bike)
      ...
      matching_b_param = matches.max_by { [it.organization_id.present? ? 1 : 0, it.created_at] }
      # Only set ownership
