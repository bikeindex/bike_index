class Admin::OrganizationsController < Admin::BaseController
  ...
  def matching_organizations
    ...
    if selected_settings.include?("unlisted")
      matching_organizations = matching_organizations.where(unlisted: true)
    end
  ...
  def organization_settings
    %w[theft_survey with_stolen_message not_approved unlisted].freeze
  end
