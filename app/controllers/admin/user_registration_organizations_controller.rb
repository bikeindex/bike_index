class Admin::UserRegistrationOrganizationsController < Admin::BaseController
  ...
  def index
    ...
    @render_org_counts = BinxUtils::InputNormalizer.boolean(params[:search_org_counts])
  end
  ...
  def matching_user_registration_organizations
    ...
    @with_registration_info = BinxUtils::InputNormalizer.boolean(params[:search_with_registration_info])
