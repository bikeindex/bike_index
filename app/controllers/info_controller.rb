...
class InfoController < ApplicationController
  ...
  def resources
    ...
    @dev_resources = [
      ...
      {title: "Personal Bike Display Widget", description: "Show your registered bikes on your personal website (requires login — also, has no usage instructions...).", link_text: "Get Widget Code", url: current_user ? user_embed_path(current_user) : new_user_path(return_to: resources_path)},
