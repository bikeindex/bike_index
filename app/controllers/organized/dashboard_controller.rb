  ...
  class DashboardController < Organized::BaseController
    ...
    def index
      ...
      if current_organization.regional?
        ...
        @bikes_in_organization_count = current_organization.bikes.where(created_at: @time_range).count(:all)
        ...
        @bikes_in_region_not_in_organizations_count = @bikes_not_in_organizations.count(:all)
      end
    end
