  ...
  class RegistrationsController < Organized::BaseController
    ...
    def index
      ...
      if current_organization.enabled?("bike_search")
        ...
        @interpreted_params[:search_email] = params[:search_email] if params[:search_email].present?
        @interpreted_params[:search_notes] = params[:search_notes] if params[:search_notes].present?
