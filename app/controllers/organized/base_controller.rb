module Organized
  class BaseController < ApplicationController
    ...
    def ensure_admin!
      ...
      flash[:error] = I18n.t(:must_be_org_admin,
    ...
    def ensure_ambassador_authorized!
      if current_organization&.ambassador?
        ...
        flash[:error] = I18n.t(:must_be_ambassador,
          scope: [:controllers, :organized, :base, __method__])
      else
        flash[:error] = I18n.t(:must_be_in_ambassador_org,
          scope: [:controllers, :organized, :base, __method__])
      end
    ...
    def ensure_not_ambassador_organization!
      ...
      flash[:error] = I18n.t(:must_be_an_admin,
        scope: [:controllers, :organized, :base, __method__])
      redirect_to(organization_root_path) && return
    end

    def raise_do_not_have_access!
      flash[:error] = I18n.t(:raise_do_not_have_access, scope: [:controllers, :organized, :base])
      redirect_to(organization_root_path) && return
    end
  end
end
