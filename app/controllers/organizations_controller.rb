class OrganizationsController < ApplicationController
  ...
  def lightspeed_interface
    ...
    if current_user.present?
      flash[:info] = I18n.t(:must_create_an_organization_first)
      redirect_to new_organization_path
    else
      flash[:info] = I18n.t(:must_create_an_account_first)
  ...
  def create
    ...
    if @organization.save
      ...
      flash[:success] = I18n.t(:organization_created)
      if current_user.present?
