class OrganizationsController < ApplicationController
  ...
  def lightspeed_interface
    ...
    if current_user.present?
      flash[:info] = translation_with_args(:must_create_an_organization_first)
      redirect_to new_organization_path
    else
      flash[:info] = translation_with_args(:must_create_an_account_first)
  ...
  def create
    ...
    if @organization.save
      ...
      flash[:success] = translation_with_args(:organization_created)
      if current_user.present?
  ...
  def set_bparam
    ...
    unless find_organization.auto_user.present?
      flash[:error] = translation_with_args(:no_user)
  ...
  def find_organization
    ...
    flash[:error] = translation_with_args(:not_found)
    redirect_to(root_url) && return
  end
