module ApplicationHelper
  ...
  def current_page_skeleton
    ...
    when "edits", "theft_alerts", "recovery"
      "edit_bike_skeleton"
    when "info"
      "content_skeleton" unless %w[terms security vendor_terms privacy support_the_index dev_and_design].include?(action_name)
    when "welcome"
  ...
  def body_class
    ...
    elsif controller_name == "info" && action_name == "dev_and_design"
      "kelsey_landing-page-body"
