...
<!-- unfortunately, codeclimate doesn't work for parallelized loads right now. So I'm commenting it out. [![Test Coverage](https://codeclimate.com/github/bikeindex/bike_index/badges/coverage.svg)](https://codeclimate.com/github/bikeindex/bike_index) -->
