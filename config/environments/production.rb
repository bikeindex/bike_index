Bikeindex::Application.configure do
  ...
  config.assets.precompile += %w( graphs.js embed.js embed_user.js spoke_card.css embed_styles.css embed_user_styles.css registration_pdf.css updated.css documentation_v2.css documentation_v2.js revised.css application_revised.js)
