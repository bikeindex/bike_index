...
# maps R2 bucket. See .github/workflows/upload-basemap.yml for uploading the tiles.
...
# we refresh quarterly - spec/config/map_tiles_spec.rb re-checks the live tiles
