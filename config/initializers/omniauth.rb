Rails.application.config.middleware.use OmniAuth::Builder do
  ...
  provider :globalid, ENV["GLOBALID_CLIENT_ID"], ENV["GLOBALID_CLIENT_SECRET"],
    scope: "openid", decrypt_pii_on_login: true, acrc_id: ENV["ACRC_ID"], provider_ignores_state: true,
    private_key: ENV["GLOBALID_PRIVATE_KEY"], private_key_pass: ENV["GLOBALID_PRIVATE_KEY_PASS"]
end
