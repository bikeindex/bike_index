...
RSpec.describe EmailJobs::ImpoundClaimJob, type: :job do
  ...
  it "doesn't send an email for pending claims" do
    expect {
      EmailJobs::ImpoundClaimJob.new.perform(impound_claim.id)
  ...
  context "submitted" do
    ...
    it "sends just once" do
      ...
      expect(CallbackJobs::AfterUserChangeJob.jobs.count).to eq 1 # To bump user so
