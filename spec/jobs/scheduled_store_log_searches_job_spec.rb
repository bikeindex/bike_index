...
RSpec.describe ScheduledStoreLogSearchesJob, type: :job do
  ...
  describe "perform" do
    ...
    let(:log_line) { 'I, [2023-10-23T13:18:57.628282 #444563]  INFO -- : [74dbf83c-07ca-4bcf-ac82-aa9c6d9ab1f4] {"method":"GET","path":"/o/brakebills/impound_records","format":"html","controller":"Organized::ImpoundRecordsController","action":"index","status":200,"duration":49.0,"view":28.72,"db":10.93,"remote_ip":"11.11.22.11","u_id":111,"params":{"organization_id":"brakebills"},"@timestamp":"2023-10-23T13:18:57.628Z","@version":"1","message":"[200] GET /o/brakebills/impound_records (Organized::ImpoundRecordsController#index)"}' }
