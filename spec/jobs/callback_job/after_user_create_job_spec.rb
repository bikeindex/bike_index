...
RSpec.describe CallbackJob::AfterUserCreateJob, type: :job do
  ...
  describe "perform" do
    context "stage: new" do
      ...
      it "sends confirmation email" do
        ...
        }.to change(CallbackJob::AfterUserCreateJob.jobs, :count).by 1
    ...
    context "stage: merged" do
      it "associates" do
        ...
        }.to_not change(CallbackJob::AfterUserCreateJob.jobs, :count)
      end
    end
