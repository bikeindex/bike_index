...
RSpec.describe FetchMailchimpMembersJob, type: :job do
  ...
  describe "perform" do
    context "organization" do
      ...
      let(:mailchimp_updated_at) { BinxUtils::TimeParser.parse("2021-06-11T19:06:19+00:00") }
    ...
    context "individual" do
      ...
      let(:mailchimp_updated_at) { BinxUtils::TimeParser.parse("2021-06-11T20:11:41+00:00") }
