...
if !ENV["CI"] && facebook_imported && Facebook::AdsIntegration::TOKEN.present?
  RSpec.describe BikeJobs::ActivateTheftAlertJob, type: :job do
    ...
    describe "perform" do
      ...
      let(:promoted_alert) { FactoryBot.create(:promoted_alert, :paid, theft_alert_plan: theft_alert_plan, stolen_record: stolen_record) }
      before do
