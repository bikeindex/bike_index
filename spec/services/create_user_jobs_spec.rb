...
describe CreateUserJobs do
  describe 'associate_ownerships' do
    it 'assigns any ownerships that match the user email' do
      bike = FactoryBot.create(:bike, owner_email: 'owner1@a.com')
      ownership = FactoryBot.create(:ownership, owner_email: 'OWner1@a.com', bike: bike)
      bike2 = FactoryBot.create(:bike, owner_email: 'owner1@a.com')
      ownership2 = FactoryBot.create(:ownership, owner_email: 'owner1@a.com', bike: bike2)
      bike3 = FactoryBot.create(:bike, owner_email: 'owner1@a.com')
      ownership3 = FactoryBot.create(:ownership, owner_email: 'owner1@a.com', bike: bike3)
      user = FactoryBot.create(:user, email: 'owner1@A.COM')
  ...
  describe 'associate_membership_invites' do
    it 'assigns any organization invitations that match the user email, and mark user confirmed if invited' do
      ...
      organization_invitation = FactoryBot.create(:organization_invitation, invitee_email: 'owNER1@a.com')
      user = FactoryBot.create(:user, email: 'owner1@A.COM')
      user.reload
