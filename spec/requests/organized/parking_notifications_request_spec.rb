  ...
  describe "create" do
    ...
    context "geolocated" do
      ...
      it "creates" do
        ...
        expect_hashes_to_match(parking_notification, parking_notification_params.except(:use_entered_address))
      ...
      context "manual address and repeat" do
        ...
        it "creates", vcr: true do
          ...
          expect_hashes_to_match(parking_notification, parking_notification_params.except(:use_entered_address, :is_repeat, :latitude, :longitude))
          expect(parking_notification.user).to eq current_user
          expect(parking_notification.organization).to eq current_organization
