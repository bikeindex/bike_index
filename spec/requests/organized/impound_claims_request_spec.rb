...
RSpec.describe Organized::ImpoundClaimsController, type: :request do
  ...
  let(:impound_claim) { FactoryBot.create(:impound_claim, impound_record: impound_record, stolen_record: bike.current_stolen_record) }
  ...
  describe "index" do
    ...
    context "multiple impound_records" do
      ...
      it "finds by bike searches and also by impound scoping" do
        ...
        expect(impound_claim.bike_claiming&.id).to eq bike.id
