...
RSpec.describe Admin::SocialPostsController, type: :request do
  ...
  describe "create" do
    ...
    # end
    # context "imported_post" do
    #   it "gets the post from twitter" do
    #     # TODO: Actually test
    #   end
    # end
  end
  ...
  describe "#destroy" do
    context "given a successful deletion" do
      it "deletes the post, redirects to post index url with an appropriate flash" do
        social_post = FactoryBot.create(:social_post)
    ...
    context "given a failed deletion" do
      it "redirects to post edit url with an appropriate flash" do
        social_post = FactoryBot.create(:social_post)
        allow(social_post).to receive(:destroy).and_return(false)
        allow(SocialPost).to receive(:friendly_find).with(social_post.id.to_s).and_return(social_post)
