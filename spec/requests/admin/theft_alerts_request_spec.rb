...
RSpec.describe Admin::TheftAlertsController, type: :request do
  context "given a logged-in superuser" do
    ...
    let(:stolen_record) { FactoryBot.create(:stolen_record, :in_vancouver_legacy, approved: true) }
    ...
    describe "create" do
      let!(:theft_alert_plan) { FactoryBot.create(:theft_alert_plan) }
      let(:stolen_record) { FactoryBot.create(:stolen_record, :in_vancouver_legacy, :with_images, approved: true) }
