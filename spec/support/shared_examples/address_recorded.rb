...
RSpec.shared_examples "address_recorded" do
  ...
  describe "CallbackJob::AddressRecordUpdateAssociationsJob updates" do
    ...
    it "is updated from the job" do
      ...
      # locations handle geocoding independently via Geocodeable
      unless subject.instance_of?(Bike) || subject.instance_of?(Location) || subject.instance_of?(ImpoundRecord)
