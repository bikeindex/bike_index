...
RSpec.describe Registrations::Show::Subtitle::Component, type: :component do
  ...
  it "combines year, manufacturer and model with the colors" do
    render_inline(component)
    expect(page).to have_text("2020")
    expect(page).to have_text("Rocket")
    expect(page).to have_text("Blue")
    expect(page).to have_text(BikeServices::Displayer.manufacturer_name(bike))
  end
end
