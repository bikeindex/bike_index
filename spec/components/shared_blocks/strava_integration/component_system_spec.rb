...
RSpec.describe SharedBlocks::StravaIntegration::Component, type: :system do
  let(:preview_path) { "/rails/view_components/shared_blocks/strava_integration/component/#{preview}" }
