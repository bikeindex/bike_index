...
RSpec.describe Pages::MyAccount::StravaIntegration::Component, type: :system do
  let(:preview_path) { "/rails/view_components/pages/my_account/strava_integration/component/#{preview}" }
