...
RSpec.describe Pages::Search::Form::Component, :js, type: :system do
  let(:preview_path) { "/rails/view_components/pages/search/form/component/default" }
  ...
  describe "EverythingCombobox", :flaky do
    ...
    context "chicago_tall_bike" do
      let(:preview_path) { "/rails/view_components/pages/search/form/component/chicago_tall_bike" }
      ...
      it "renders the counts", vcr: {cassette_name: :search_form_component_chicago_tall_bike} do
        ...
        proximity_text = find("[data-test-id=\"Pages::Search::KindOption-proximity\"]").text
    ...
    context "for_sale" do
      ...
      let(:preview_path) { "/rails/view_components/pages/search/form/component/for_sale" }
      it "renders and updates" do
        ...
        proximity_text = find("[data-test-id=\"Pages::Search::KindOption-for_sale_proximity\"]").text
        # Counts should have been hidden because a new item was added
      ...
      context "for_sale_san_francisco_atb" do
        let(:preview_path) do
          ...
          "/rails/view_components/pages/search/form/component/for_sale_san_francisco_atb"
        end
