...
RSpec.describe Pages::Admin::Organizations::LandingPagesTable::Component, type: :component do
  let(:component) { with_request_url("/admin/organization_landing_pages") { render_inline(described_class.new(collection: [landing_page], sort_state: ComponentStructs::SortState.new(search_params: {period: "all"}), render_search:)) } }
