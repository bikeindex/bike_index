...
RSpec.describe Pages::Admin::Organizations::Form::SamlSso::Component, type: :component do
  let(:organization) do
  ...
  def rendered_component(organization)
    render_in_view_context do
      form_for [:admin, organization] do |f|
        render(Pages::Admin::Organizations::Form::SamlSso::Component.new(form_builder: f))
      end
    end
  end
