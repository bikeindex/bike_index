...
RSpec.describe Pages::Admin::Organizations::Form::Wrapper::Component, type: :component do
  let(:organization) { FactoryBot.create(:organization) }

  def rendered_component(organization)
    render_in_view_context do
      form_for [:admin, organization] do |f|
        render(Pages::Admin::Organizations::Form::Wrapper::Component.new(form_builder: f))
      end
    end
  end
