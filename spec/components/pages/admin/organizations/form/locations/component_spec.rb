...
RSpec.describe Pages::Admin::Organizations::Form::Locations::Component, type: :component do
  ...
  def rendered_component(organization)
    render_in_view_context do
      form_for [:admin, organization] do |f|
        render(Pages::Admin::Organizations::Form::Locations::Component.new(form_builder: f))
      end
    end
  end
