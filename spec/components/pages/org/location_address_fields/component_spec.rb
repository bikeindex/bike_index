...
RSpec.describe Pages::Org::LocationAddressFields::Component, type: :component do
  ...
  def rendered_component(address_record, options)
    render_in_view_context do
      form_for address_record, url: "#", method: :patch do |f|
        render(Pages::Org::LocationAddressFields::Component.new(**options.merge(form_builder: f)))
      end
    end
  end
