...
RSpec.describe Messages::ThreadShow::Component, type: :component do
  ...
  let(:options) { {marketplace_messages:, initial_message:, current_user:, can_send_message:} }
  ...
  it "buyer" do
    ...
    expect(component).to have_content "Send message"
  ...
  #     component_text = whitespace_normalized_body_text(component.to_html)
  #     expect(component_text).to match(/send message/i)
  ...
  #       component_text = whitespace_normalized_body_text(component.to_html)
  #       expect(component_text).to_not match(/send message/i)
  #       expect(component_text).to match(/Me \(#{current_user.marketplace_message_name}\)/)
  #       expect(component_text).to match(/to #{marketplace_message.receiver.marketplace_message_name}/)
  #       expect(component_text).to match(/bike sold to/)
  #     end
