...
RSpec.describe SearchOrg::Form::Component, :js, type: :system do
  let(:preview_path) { "/rails/view_components/search_org/form/component/default" }
  ...
  describe "without_serial_field preview" do
    let(:preview_path) { "/rails/view_components/search_org/form/component/without_serial_field" }
  ...
  describe "with_serial_value preview" do
    let(:preview_path) { "/rails/view_components/search_org/form/component/with_serial_value" }
