...
RSpec.describe Form::LegacyFormWell::AddressRecord::Component, :js, type: :system do
  let(:base_path) { "/rails/view_components/form/legacy_form_well/address_record/component/" }
