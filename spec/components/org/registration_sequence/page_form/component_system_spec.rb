...
RSpec.describe Org::RegistrationSequence::PageForm::Component, :js, type: :system do
  let(:preview_path) { "/rails/view_components/org/registration_sequence/page_form/component/default" }
