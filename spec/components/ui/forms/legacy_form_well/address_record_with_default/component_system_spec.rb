...
RSpec.describe UI::Forms::LegacyFormWell::AddressRecordWithDefault::Component, :js, type: :system do
  let(:preview_path) { "/rails/view_components/ui/forms/legacy_form_well/address_record_with_default/component/default" }
