...
RSpec.describe UI::Forms::LegacyFormWell::AddressRecord::Component, :js, type: :system do
  let(:base_path) { "/rails/view_components/ui/forms/legacy_form_well/address_record/component/" }
