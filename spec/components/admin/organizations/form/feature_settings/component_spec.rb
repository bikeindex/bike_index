...
RSpec.describe Admin::Organizations::Form::FeatureSettings::Component, type: :component do
  ...
  def rendered_component(organization, current_user)
    render_in_view_context do
      form_for [:admin, organization] do |f|
        render(Admin::Organizations::Form::FeatureSettings::Component.new(form_builder: f, current_user:))
      end
    end
  end
