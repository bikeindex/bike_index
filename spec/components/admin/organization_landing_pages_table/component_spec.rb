...
RSpec.describe Admin::OrganizationLandingPagesTable::Component, type: :component do
  let(:component) { with_request_url("/admin/organization_landing_pages") { render_inline(described_class.new(collection: [landing_page], sortable_search_params: {period: "all"}, render_search:)) } }
