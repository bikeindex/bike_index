...
# RSpec.describe 'custom match_hash_indifferently and RspecHashMatcher' do # rubocop:disable RSpec/DescribeClass
...
#       expect(nonprofit).to match_hash_indifferently(hash_1)
#     end
...
#         expect(nonprofit).not_to match_hash_indifferently(hash_2)
#       end
#     end
#   end
