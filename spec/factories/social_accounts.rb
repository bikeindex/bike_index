FactoryBot.define do
  factory :social_account do
    sequence(:screen_name) { |n| "TestSocialAccount#{n}" }
    ...
    factory :social_account_1 do
      ...
      account_info { {name: "name", profile_image_url_https: "https://example.com/image.jpg"} }
    end

    factory :social_account_2 do
