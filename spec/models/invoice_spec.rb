...
RSpec.describe Invoice, type: :model do
  ...
  describe "two invoices" do
    ...
    let(:paid_feature2) { FactoryBot.create(:paid_feature, feature_slugs: ["additional_registration"]) }
    ...
    it "adds the paid features" do
      ...
      expect(organization.enabled_feature_slugs).to match_array %w[bike_search additional_registration]
    end
  end
end
