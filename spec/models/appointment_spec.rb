...
RSpec.describe Appointment, type: :model do
  ...
  # Someday we may want this logic - but for now we're just going to use the ticket line_ordering
    ...
    context "no_user" do
      ...
      context "new_status being_helped" do
        ...
        it "updates - and updates ticket" do
          ...
          expect(appointment.resolved?).to be_truthy
          ticket.reload
          expect(ticket.status).to eq "being_helped"
          expect(ticket.resolved?).to be_truthy
