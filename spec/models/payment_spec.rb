...
RSpec.describe Payment, type: :model do
  ...
  describe "stripe_success_url, stripe_cancel_url" do
    ...
    context "theft_alert" do
      ...
      let(:target_success) { "http://test.host/bikes/#{theft_alert.bike_id}/edit?edit_template=alert_purchase_confirmation&session_id={CHECKOUT_SESSION_ID}" }
      let(:target_cancel) { "http://test.host/bikes/#{theft_alert.bike_id}/edit?edit_template=alert" }
