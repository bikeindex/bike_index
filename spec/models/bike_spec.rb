  ...
  describe "searchable_interpreted_params" do
    context "multiple query_items strings" do
      ...
      context "with vehicle_type" do
        ...
        let(:query_params_slug) { {query_items: multi_query_items + ["v_trailer"]} }
        ...
        it "returns" do
          ...
          expect(Bike.searchable_interpreted_params(query_params_slug, ip: ip_address)).to eq target_with_cycle_type
        end
      end
