...
RSpec.describe ApplicationHelper, type: :helper do
  describe "phone_link and phone_display" do
    ...
    context "with extension" do
      let(:target) { '<a href="tel:+111211111;2929222">+11-121-1111 x 2929222</a>' }
      it "returns link" do
    ...
    context "passed class" do
      let(:target) { '<a class="phone-number-link" href="tel:7777777777;2929222">777-777-7777 x 2929222</a>' }
      it "has class" do
