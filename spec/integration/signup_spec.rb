...
RSpec.describe "Signup", type: :system do
  ...
  # so the examples that need an account start here, signed in and nudged to set a password
  ...
  # Every step of the flow above is a plain form, so it runs with scripting off too
  context "without JavaScript", driver: :playwright_no_js do
