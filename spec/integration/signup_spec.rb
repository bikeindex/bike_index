...
RSpec.shared_context :signup_flow_steps do
  ...
  # so every example starts here, signed in and nudged to set a password. A shared context
  # rather than a method, since the no-JavaScript describe below is a sibling
