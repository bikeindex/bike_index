...
# Based on I18n::Tasks::ConservativeRouter and IsolatingRouter
#
# Custom router required because we have existing translations in config/locales -
# but want to put new translations in the component sidecar directories

module I18n::Tasks
  # Keep the path, or infer from base locale
  # Unless in components
  class BikeIndexRouter < I18n::Tasks::Data::Router::PatternRouter
    # Keep the path, or infer from base locale
