...
priority_manufacturer_names = [
  ...
  "GT Bicycles", "Handsome Cycles", "Haro", "Ibis", "Intense", "IZIP", "Jamis",
  "Jetson", "Juliana Bicycles", "KHS Bicycles", "Kink", "Kona", "Marin Bikes",
  "Mongoose", "Moots Cycles", "Niner", "Nishiki", "Norco Bikes", "Orbea",
  "Pinarello", "Pivot", "Pure Cycles (Pure Fix Cycles)", "Rad Power Bikes",
  "Raleigh", "Redline", "Ridley", "Riese & Müller (Riese and Muller)",
  "Rocky Mountain Bicycles", "Salsa", "Santa Cruz", "Schwinn", "SCOTT",
  "SE Bikes", "Soma", "Specialized", "Strider (Strider sports)", "Sunday",
  "Surly", "Tern", "Transition Bikes", "Trek", "Urban Arrow", "Velotric",
  "Woom", "Yeti", "Yuba"
]
