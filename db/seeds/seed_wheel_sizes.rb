...
wheel_sizes = [
  ...
  { name: '650 C', iso_bsd: 571, priority: 1, description: 'Smaller road bikes, 27.5 mountain bikes (Standard size)' },
  { name: '650 B', iso_bsd: 584, priority: 3, description: '650B, 26 x 1 1/2 (Uncommon)' },
