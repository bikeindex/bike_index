...
// Morning run
const morningRun: StoredActivity = {
  id: 16211859713,
  strava_id: '16211859713',
  activity_type: 'Run',
  average_speed: 3.421,
  description: '',
  distance_meters: 10926.0,
  kudos_count: 12,
  moving_time_seconds: 3194,
  photos: { photo_url: null, photo_count: 0 },
  private: false,
  segment_locations: {},
  sport_type: 'Run',
  start_date: '2025-10-21T08:46:45.000-05:00',
  suffer_score: 35.0,
  timezone: 'America/Los_Angeles',
  title: 'Morning hang',
  total_elevation_gain_meters: 42.7,
  gear_id: 'g21560884',
  trainer: false,
  muted: false,
  commute: false,
  ...
  start_date_in_zone: '2025-10-21T06:46:45.000-07:00',
  athleteId: 12345,
  syncedAt: Date.now(),
};
...
const rando400k: StoredActivity = {
  ...
  enriched_at: '2026-02-01T00:00:00Z',
  pr_count: 56,
  top_10_ranks: [1, 1, 2, 3, 4, 6, 8, 9, 10],
